...
export const PALETTES: Record<Genre, Palette> = {
  Synthwave: {
    ...
    swing:0,octave:4,humanize:0,mix:[.8,.6,.35,.62,.43,.38],progressions:[[0,5,2,6],[0,3,5,4],[0,6,5,3],[0,2,3,4],[5,3,0,4]]
  },
  House: {
    ...
    swing:.025,octave:4,humanize:.004,mix:[.9,.5,.45,.65,.36,.48],progressions:[[0,3,5,4],[0,5,3,4],[0,4,5,3],[1,4,0,5],[3,4,0,0]]
  },
  'Lo-fi': {
    ...
    swing:.2,octave:4,humanize:.012,mix:[.68,.5,.24,.6,.47,.44],progressions:[[1,4,0,5],[0,3,1,4],[5,1,4,0],[0,2,5,1],[3,2,1,0]]
  },
  Ambient: {
    ...
    swing:0,octave:5,humanize:.012,mix:[0,0,0,.35,.35,.65],progressions:[[0,3,0,5],[0,5,3,0],[0,2,5,3],[0,0,3,3],[5,3,0,0]]
  },
  'Drum & bass': {
